...
source_folder=${5:-"/home/${user_name}/catkin_ws_aimen"}
...
# ros environment
source ${catkin_folder}/src/guardian_config/install/2_configuration_files/ros.bash ${ros_version} ${user_name} ${source_folder}
